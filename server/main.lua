...
QBCore.Commands.Add(Config.Commands.navSet, "Create a shareable POI",
  { { name = "locationname", help = "Give your POI a unique name." } }, true, function(source, args)
...
QBCore.Commands.Add(Config.Commands.navTo, "Set a location marker for shareable POI",
  { { name = "locationname", help = "Provide POI name" } }, true, function(source, args)
  local name = args[1]:lower()
